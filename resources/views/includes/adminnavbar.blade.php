...
<div class="topnav" id="myTopnav">
    <div class="navitem">
        <a href="{{ route('admin.categories') }}">{{__('lang.Categories')}}</a>
    </div>

    <div class="navitem">
        <a href="{{ route('admin.subCategories') }}">{{__('lang.Sub Categories')}}</a>
    </div>
    <div class="navitem">
        <a href="{{ route('admin.products') }}">{{__('lang.Products')}}</a>
    </div>
    <div class="navitem">
        <a href="{{ route('admin.bestSeller') }}">{{__('lang.Best Seller')}}</a>
    </div>
    <div class="navitem" >
        <div class="dropup">
    ...
    <a class="navitem" href="{{ route('logout') }}"
